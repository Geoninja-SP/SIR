...
# Versión v10 - Contextos depurados y fases uniformes
# ============================================================
# Base funcional:
...
def mostrar_contextos_automaticos(
    ...
    """
    Presenta el contexto obtenido desde los datos maestros.

    Los contextos con información se muestran como tarjetas activas.
    Los contextos sin relación se muestran bloqueados y en gris.
    En Persona solo se presentan Persona, Hogar, Lugar poblado y Predio.
    """
